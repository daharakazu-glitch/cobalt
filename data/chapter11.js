...
window.CHAPTER_DATA = [
  ...
  },
  {
    ...
    question: "The cheering was so loud that I could （　） hear my own voice.",
    choices: ["hardly", "almost", "mostly", "nearly"],
    answerIndex: 0,
    ja: "応援があまりに大きくて、自分の声がほとんど聞こえなかった。",
    en: "The cheering was so loud that I could hardly hear my own voice.",
    explanation: "hardly / scarcely は「ほとんど〜ない」という準否定の副詞。almost / nearly は「ほとんど〜だ」で否定の意味を持たない点が対比で問われる。（※県内屈指の声量を誇る応援団）",
  ...
  },
  {
    ...
    question: "次の日本語に合うように語句を並べ替えなさい。\n「もう一回みんなで応援歌を歌わない？」",
    pieces: ["Why", "don't", "we", "sing", "the cheer song", "together", "one more time"],
    answer: "Why don't we sing the cheer song together one more time",
    ja: "もう一回みんなで応援歌を歌わない？",
    en: "Why don't we sing the cheer song together one more time?",
    explanation: "Why don't we ~? は「（一緒に）〜しない？」という勧誘表現（= Shall we ~? / How about ~ing?）。Why don't you ~? なら相手への提案「〜したら？」になる。（※歌い出したら止まらない「空はコバルト」）",

...
window.CHAPTER_DATA = [
  {
    ...
    img: "assets/illust/chapter02/001.svg"
  },
  {
    id: "002",
    tags: ["基本", "超頻出"],
    ...
    img: "assets/illust/chapter02/002.svg"
  },
  {
    id: "003",
    tags: ["超頻出"],
    ...
    img: "assets/illust/chapter02/003.svg"
  },
  {
    id: "004",
    tags: ["超頻出", "発展"],
    ...
    img: "assets/illust/chapter02/004.svg"
  },
  {
    id: "005",
    tags: ["超頻出"],
    ...
    img: "assets/illust/chapter02/005.svg"
  },
  {
    id: "006",
    tags: ["発展", "超頻出"],
    ...
    question: "The new rugby players （　） up the hill behind the school until their legs gave out.",
    choices: ["were made run", "were made to run", "made to run", "were making run"],
    answerIndex: 1,
    ja: "ラグビー部の新入部員たちは、脚が動かなくなるまで学校裏の坂を走らされた。",
    en: "The new rugby players were made to run up the hill behind the school until their legs gave out.",
    explanation: "使役 make + O + 原形 は、受動態になると to が復活して be made to do となる。（※脚が生まれたての子鹿になるまで走るのがラグビー部の春の恒例）",
    img: "assets/illust/chapter02/006.svg"
  },
  {
    id: "007",
    tags: ["発展", "超頻出"],
    ...
    img: "assets/illust/chapter02/007.svg"
  },
  {
    id: "008",
    tags: ["発展"],
    ...
    img: "assets/illust/chapter02/008.svg"
  },
  {
    id: "009",
    tags: ["超頻出"],
    ...
    img: "assets/illust/chapter02/009.svg"
  },
  {
    id: "010",
    tags: ["超頻出"],
    ...
    question: "次の日本語に合うように語句を並べ替えなさい。\n「南高の吹奏楽部は、その力強いサウンドで県中に知られている。」",
    pieces: ["Nanko's brass band", "is", "known", "to", "the whole prefecture", "for", "its powerful sound"],
    answer: "Nanko's brass band is known to the whole prefecture for its powerful sound",
    ja: "南高の吹奏楽部は、その力強いサウンドで県中に知られている。",
    en: "Nanko's brass band is known to the whole prefecture for its powerful sound.",
    explanation: "be known to ~「〜に知られている」、be known for ~「〜（という理由）で知られている」。1文の中で両方を並べる整序が頻出。（※コンクールでも体育祭の入場行進でも鳴り響く南高サウンド）",
    img: "assets/illust/chapter02/010.svg"
  },
  {
    id: "011",
    tags: ["超頻出"],
    ...
    img: "assets/illust/chapter02/011.svg"
  },
  {
    id: "012",
    tags: ["基本", "超頻出"],
    ...
    question: "Everyone was surprised （　） the little explosion the chemistry club made during the demonstration.",
    answer: ["at", "by"],
    ja: "公開実験で化学部が起こした小さな爆発に、みんな驚いた。",
    en: "Everyone was surprised at the little explosion the chemistry club made during the demonstration.",
    explanation: "感情を表す受動態は前置詞とセットで覚える。be surprised at ~（by も可）。be interested in / be satisfied with なども同様。（※もちろん想定内の演出。化学部いわく『これが科学です』）",
    img: "assets/illust/chapter02/012.svg"
  },
  {
    id: "013",
    tags: ["基本"],
    ...
    img: "assets/illust/chapter02/013.svg"
  },
  {
    id: "014",
    tags: ["発展"],
    ...
    img: "assets/illust/chapter02/014.svg"
  },
  {
    id: "015",
    tags: ["超頻出"],
    ...
    img: "assets/illust/chapter02/015.svg"
  },
  {
    id: "016",
    tags: ["発展"],
    ...
    img: "assets/illust/chapter02/016.svg"
  }
];

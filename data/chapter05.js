...
window.CHAPTER_DATA = [
  ...
  },
  {
    ...
    question: "It took the mountaineering club two full days （　） all the tents up to the mountain hut.",
    choices: ["carry", "carrying", "to carry", "carried"],
    answerIndex: 2,
    ja: "山岳部がすべてのテントを山小屋まで運び上げるのに、まる2日かかった。",
    en: "It took the mountaineering club two full days to carry all the tents up to the mountain hut.",
    explanation: "It takes + 人 + 時間 + to do「人が〜するのに（時間が）かかる」。形式主語 It が to 以下を受ける。（※重い荷を背負って登る「歩荷（ぼっか）訓練」は山岳部の夏の風物詩）",
  ...
  },
  {
    ...
    question: "The seniors expect every new member （　） the racket five hundred times before breakfast.",
    choices: ["swing", "to swing", "swinging", "swung"],
    answerIndex: 1,
    ja: "先輩たちは、新入部員全員が朝食前にラケットを500回素振りすることを期待している。",
    en: "The seniors expect every new member to swing the racket five hundred times before breakfast.",
    explanation: "expect + O + to do「Oが〜することを期待する」。want / ask / tell / advise も同じ「O + to do」の型をとる。（※バドミントン部の朝は素振りの風切り音から始まる）",
  ...
  },
  {
    ...
    question: "次の日本語に合うように語句を並べ替えなさい。\n「最終種目のリレーはあまりに白熱して、誰も席に座っていられなかった。」",
    pieces: ["The final relay", "was", "too", "exciting", "for anyone", "to", "stay", "in their seats"],
    answer: "The final relay was too exciting for anyone to stay in their seats",
    ja: "最終種目のリレーはあまりに白熱して、誰も席に座っていられなかった。",
    en: "The final relay was too exciting for anyone to stay in their seats.",
    explanation: "too + 形容詞 + for A + to do「あまりに〜なのでAは…できない」。for A が不定詞の意味上の主語。（※毎年ここで盛り上がりすぎて救急車が来る。今年も来た）",

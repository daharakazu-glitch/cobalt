...
window.CHAPTER_DATA = [
  ...
  },
  {
    ...
    type: "choice",
    point: "現在完了進行形（継続）",
    question: "Our class （　） for the tug-of-war since dawn, and the teachers are getting worried.",
    choices: ["practices", "is practicing", "has been practicing", "practiced"],
    answerIndex: 2,
    ja: "うちのクラスは夜明けからずっと綱引きの練習をしていて、先生たちが心配し始めている。",
    en: "Our class has been practicing for the tug-of-war since dawn, and the teachers are getting worried.",
    explanation: "since dawn（過去のある時点から今まで）と動作の継続を表すので現在完了進行形 have been ~ing。class は一つのまとまりとして単数扱いなので has。（※クラス対抗の体育祭は毎年白熱しすぎて救急車で運ばれる生徒が出るほど。県教育委員会も注視中）",
  ...
  },
  {
    ...
    question: "次の日本語に合うように語句を並べ替えなさい。\n「柔道部は3時間ずっと全力で受け身の練習を続けている。」",
    pieces: ["The judo team", "has", "been", "practicing", "breakfalls", "at full speed", "for", "three hours"],
    answer: "The judo team has been practicing breakfalls at full speed for three hours",
    ja: "柔道部は3時間ずっと全力で受け身の練習を続けている。",
    en: "The judo team has been practicing breakfalls at full speed for three hours.",
    explanation: "過去から今まで継続している動作は現在完了進行形 have been ~ing。期間は for three hours。breakfall は柔道の「受け身」。（※道場の畳の音が校舎の端まで響くのが南高の夕方）",
  ...
  },
  {
    ...
    type: "fill",
    point: "起点の since",
    question: "Our swimming team has trained in this outdoor pool （　） early April.",
    answer: ["since"],
    ja: "うちの水泳部は4月の初めから、この屋外プールでずっと練習している。",
    en: "Our swimming team has trained in this outdoor pool since early April.",
    explanation: "現在完了で「〜から（起点）」を表すのは since。three years のような期間には for を使う。（※山形の4月の屋外プールはほぼ修行。それでも飛び込むのが水泳部の意地）",

...
window.CHAPTER_DATA = [
  {
    ...
    question: "That guy pushing a tackle dummy up the hill alone at midnight （　） be entirely sane.",
    choices: ["must", "can't", "should", "would"],
    answerIndex: 1,
    ja: "真夜中に一人でタックルダミーを押して坂を登っているあいつが、完全に正気のはずがない。",
    en: "That guy pushing a tackle dummy up the hill alone at midnight can't be entirely sane.",
    explanation: "「〜のはずがない」という強い否定の推量は can't [cannot] be。肯定の推量 must be（〜にちがいない）と対で覚える。（※ラグビー部か…いや、ラグビー部であってくれ）",
  ...
  },
  {
    ...
    question: "The judo hall smells of sweat; the wrestling team （　） borrowed it again this morning.",
    choices: ["must have", "should have", "can't have", "need have"],
    answerIndex: 0,
    ja: "柔道場が汗のにおいで満ちている。今朝もレスリング部が借りて練習したにちがいない。",
    en: "The judo hall smells of sweat; the wrestling team must have borrowed it again this morning.",
    explanation: "「〜したにちがいない」という過去への推量は must have + 過去分詞。（※柔道部・レスリング部・ボクシング部が練習場所を取り合うのが南高の朝の風景）",
  ...
  },
  {
    ...
    question: "You （　） not skip morning practice again, or the track coach will add ten extra laps.",
    choices: ["had better", "would rather", "used to", "may well"],
    answerIndex: 0,
    ja: "もう二度と朝練をサボらないほうがいい。さもないと陸上部のコーチに10周追加されるぞ。",
    en: "You had better not skip morning practice again, or the track coach will add ten extra laps.",
    explanation: "had better + 動詞の原形「〜したほうがよい」は警告に近い強い助言。否定は had better not + 原形の語順。（※コーチの言う「あと10周」は実質「あと20周」である）",

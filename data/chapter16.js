...
window.CHAPTER_DATA = [
  ...
  },
  {
    ...
    question: "次の日本語に合うように語句を並べ替えなさい。\n「リレーでの将棋倒しのあと、保健の先生は僕らを20分待たせた。」",
    pieces: ["The school nurse", "kept", "us", "waiting", "for twenty minutes", "after the relay pile-up"],
    answer: "The school nurse kept us waiting for twenty minutes after the relay pile-up",
    ja: "リレーでの将棋倒しのあと、保健の先生は僕らを20分待たせた。",
    en: "The school nurse kept us waiting for twenty minutes after the relay pile-up.",
    explanation: "keep + O + ~ing「Oを〜させ続ける」。I'm sorry to have kept you waiting.（お待たせしました）も同じ型。（※体育祭名物・保健室の大行列。毎年数名はそのまま救急車へ…お大事に）",
  ...
  },
  {
    ...
    question: "次の日本語に合うように語句を並べ替えなさい。\n「マラソン大会の仮装衣装を縫うのに3時間かかった。」",
    pieces: ["It", "took", "me", "three hours", "to sew", "my costume", "for the marathon"],
    answer: "It took me three hours to sew my costume for the marathon",
    ja: "マラソン大会の仮装衣装を縫うのに3時間かかった。",
    en: "It took me three hours to sew my costume for the marathon.",
    explanation: "It takes + 人 + 時間 + to do「人が〜するのに時間がかかる」。お金なら It costs + 人 + 金額 + to do。（※走る気はあるのかって？大いにある。仮装も本気、走りも本気の南高3年生）",

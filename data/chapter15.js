...
window.CHAPTER_DATA = [
  {
    ...
    question: "Hand in the entry form for the class relay （　） Friday.",
    choices: ["until", "by", "till", "during"],
    answerIndex: 1,
    ja: "クラス対抗リレーのエントリー用紙は金曜までに提出すること。",
    en: "Hand in the entry form for the class relay by Friday.",
  ...
  },
  {
    ...
    question: "次の日本語に合うように語句を並べ替えなさい。\n「彼女の大胆な筆づかいのおかげで、書道部は県のコンクールで大賞を取った。」",
    pieces: ["Thanks to", "her bold brushwork", "the calligraphy club", "won", "the grand prize", "at the prefectural contest"],
    answer: "Thanks to her bold brushwork the calligraphy club won the grand prize at the prefectural contest",
    ja: "彼女の大胆な筆づかいのおかげで、書道部は県のコンクールで大賞を取った。",
    en: "Thanks to her bold brushwork, the calligraphy club won the grand prize at the prefectural contest.",
    explanation: "thanks to ~「〜のおかげで」（良い原因）。悪い原因なら because of / due to ~。（※畳一枚分の紙に全身で書くのが南高書道部のスタイル）",

...
window.CHAPTER_DATA = [
  ...
  },
  {
    ...
    question: "Nothing ①could stop ②him ③from to run ④his roadwork in the heavy snow.",
    choices: ["①could stop", "②him", "③from to run", "④his roadwork in the heavy snow"],
    answerIndex: 2,
    ja: "大雪の中でも、何ものも彼のロードワークを止められなかった。",
    en: "Nothing could stop him from running his roadwork in the heavy snow.",
    explanation: "stop / prevent / keep + A + from ~ing「Aが〜するのを妨げる」。from は前置詞なので後ろは動名詞。③の to run が誤り。（※雪が深いほど燃えるのがボクシング部）",
  ...
  },
  {
    ...
    question: "次の日本語に合うように語句を並べ替えなさい。\n「山岳部が去年の夏に登ったあの山は、もう一度登る価値が十分にある。」",
    pieces: ["The mountain", "the club climbed", "last summer", "is", "well", "worth", "climbing", "again"],
    answer: "The mountain the club climbed last summer is well worth climbing again",
    ja: "山岳部が去年の夏に登ったあの山は、もう一度登る価値が十分にある。",
    en: "The mountain the club climbed last summer is well worth climbing again.",
    explanation: "be worth ~ing「〜する価値がある」。主語が意味上 ~ing の目的語になる（The mountain is worth climbing = climb the mountain）。well worth で強調。",
  ...
  },
  {
    ...
    type: "fill",
    point: "on ~ing（〜するとすぐに）",
    question: "On （　） that our judo captain had won the prefectural title, the whole class erupted.",
    answer: ["hearing"],
    ja: "柔道部の主将が県大会で優勝したと聞くやいなや、クラス全体が沸き立った。",
    en: "On hearing that our judo captain had won the prefectural title, the whole class erupted.",
    explanation: "on ~ing「〜するとすぐに」= as soon as + S + V。in ~ing なら「〜する際に」。（※南高の部活はどこも強く、廊下の優勝報告の貼り紙が渋滞する）",
  ...
  },
  {
    ...
    question: "There is no （　） how heated our class-versus-class sports festival will get this year.",
    answer: ["telling", "knowing", "predicting"],
    ja: "クラス対抗の体育祭が今年どれほど白熱するか、まったく予測がつかない。",
    en: "There is no telling how heated our class-versus-class sports festival will get this year.",
    explanation: "There is no ~ing「〜することはできない」。There is no telling ~ で「〜は誰にも分からない」。（※盛り上がりすぎ注意。今年こそ救急車ゼロを目標に掲げるクラスもある）",

...
window.CHAPTER_DATA = [
  ...
  },
  {
    ...
    question: "He practiced （　） for the talent show, hoping for cheers instead of boos.",
    choices: ["hardly", "hard", "hardly ever", "as hard"],
    answerIndex: 1,
    ja: "彼はブーイングではなく喝采をもらうために、一発芸を懸命に練習した。",
    en: "He practiced hard for the talent show, hoping for cheers instead of boos.",
  ...
  },
  {
    ...
    question: "There was （　） hope of getting the last fried bread, but he ran anyway.",
    choices: ["little", "a little", "few", "a few"],
    answerIndex: 0,
    ja: "最後の揚げパンを手に入れられる望みはほとんどなかったが、それでも彼は走った。",
    en: "There was little hope of getting the last fried bread, but he ran anyway.",
    explanation: "hope は不可算なので little / a little を使う。a が付かない little は「ほとんどない」という否定的な意味。but he ran anyway と続くので、望み薄の little が正解。",
  ...
  },
  {
    ...
    question: "By the middle of the long speech, half the audience was fast （　）.",
    choices: ["sleep", "sleepy", "asleep", "sleeping"],
    answerIndex: 2,
    ja: "長いスピーチの中盤までに、聴衆の半分はぐっすり眠り込んでいた。",
    en: "By the middle of the long speech, half the audience was fast asleep.",
    explanation: "asleep / awake / alive / alone など a- で始まる形容詞は補語にしか使えない（叙述用法のみ）。fast asleep は「ぐっすり眠って」の定型。名詞修飾には sleeping child のように分詞を使う。",
  ...
  },
  {
    ...
    question: "The bakery's fried bread has been selling out even faster （　）.",
    answer: ["lately", "recently"],
    ja: "最近、あの揚げパンの売り切れがさらに早くなっている。",
    en: "The bakery's fried bread has been selling out even faster lately.",
    explanation: "「最近」は lately / recently。現在完了（進行）形との組み合わせが自然。sell out は「売り切れる」、even faster は「さらに速く」。",
  ...
  },
  {
    ...
    type: "fill",
    point: "boring（退屈させる側）",
    question: "His opening joke was so （　） that the gym went completely silent.",
    answer: ["boring", "dull"],
    ja: "彼のつかみのギャグはあまりにつまらなくて、体育館が完全に静まり返った。",
    en: "His opening joke was so boring that the gym went completely silent.",
    explanation: "退屈「させる」側は boring、退屈「させられる」側は bored。ジョークは人を退屈させる側なので boring。go silent は「静まり返る」。（※この後のブーイングは想像にお任せ）",
